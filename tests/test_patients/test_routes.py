...
class TestPatientsGetRoutes:
    async def test_get_all_patients(
        self, client_with_mock_service: AsyncClient, mock_patient_service: Mock
    ) -> None:
        ...
        response = await client_with_mock_service.get("/patients/")
    ...
    async def test_get_patient_by_id(
        ...
        response = await client_with_mock_service.get(f"/patients/{patient.id}")
    ...
    async def test_get_patient_not_found(
        ...
        response = await client_with_mock_service.get("/patients/999999")
...
class TestPatientsCreateRoutes:
    ...
    async def test_create_patient(
        ...
        response = await client_with_mock_service.post("/patients/", json=patient_data)
    ...
    async def test_create_patient_invalid_data(
        ...
        response = await client_with_mock_service.post("/patients/", json=invalid_data)
...
class TestPatientsDeleteRoutes:
    ...
    async def test_delete_patient(
        ...
        # Delete the patient
        response = await client_with_mock_service.delete(f"/patients/{patient_id}")
        mock_patient_service.delete_patient.assert_called_once_with(patient_id)
        assert response.status_code == 204

        # Verify deletion
        get_response = await client_with_mock_service.get(f"/patients/{patient_id}")
    ...
    async def test_delete_patient_not_found(
        ...
        response = await client_with_mock_service.delete("/patients/999999")
